...
#define LENGTH_HEAD_VIEW 40 //头视图
...
- (id)initWithSuperVC:(UIViewController *)superVC andHeadImage:(NSString *)imageStr{
    self.superVC = superVC;
    
    CGRect frame = CGRectMake(0, LENGTH_HEAD_SPACE, Main_Screen_Width, 40);
...
//        //添加任务头像
//        UIImageView *personPictureImageView = [UIImageView new];
//        [personPictureImageView sd_setImageWithURL:[NSURL URLWithString:imageStr]];
////        CGRect headViewRect = CGRectMake(0, 0, LENGTH_HEAD_VIEW, LENGTH_HEAD_VIEW);
//        personPictureImageView.frame = headViewRect;
//        personPictureImageView.layer.cornerRadius = personPictureImageView.frame.size.width/2;
//        personPictureImageView.layer.borderWidth = 2;
//        personPictureImageView.layer.borderColor = [UIColor whiteColor].CGColor;
//        personPictureImageView.layer.masksToBounds = YES;
//        personPictureImageView.backgroundColor = [UIColor whiteColor];
//        [self addSubview:personPictureImageView];
        
        
        // 2、创建头像
        UIView *headImageBackView = [[UIView alloc]init];
//
        ...
        CGRect headViewRect = CGRectMake(0, 0, LENGTH_HEAD_VIEW, LENGTH_HEAD_VIEW);
        headImageBackView.frame = headViewRect;
        
        UIButton *btnHeadImage = [UIButton new];
        btnHeadImage.layer.cornerRadius = 20;
        btnHeadImage.layer.masksToBounds = YES;
        [btnHeadImage addTarget:self action:@selector(btnHeadImageClick:)  forControlEvents:UIControlEventTouchUpInside];
        [headImageBackView addSubview:btnHeadImage];
        
        // 3、创建头像下标
        UILabel *labelNum = [[UILabel alloc] init];
        btnHeadImage.titleLabel.textColor = [UIColor grayColor];
        btnHeadImage.titleLabel.textAlignment = NSTextAlignmentCenter;
        btnHeadImage.titleLabel.font = ChatTimeFont;
        btnHeadImage.titleLabel.text = @"soulfire wang";
