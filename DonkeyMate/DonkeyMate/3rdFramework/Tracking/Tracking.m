...
@property (nonatomic, strong, readwrite) BMKPointAnnotation *annotation;
@property (nonatomic, strong, readwrite) BMKPolyline *polyline;
...
- (void)execute
{
    ...
    BMKAnnotationView *annotationView = [self.mapView viewForAnnotation:self.annotation];
...
- (void)initPolyline
{
    self.polyline = [BMKPolyline polylineWithCoordinates:_coordinates count:_count];
}
